...
<body>
	<header>
		...
		<ul class="sidenav red darken-4" id="mobile-demo">
			...
			<li><a id="ext" href="addgraduado.jsp"><i
					class="material-icons">question_answer</i>REGISTRAR GRADUADO</a></li>
			<li><a id="ext" href="admin.jsp"><i class="material-icons">view_carousel</i>VOLVER</a></li>
		...
		<section class="container">
			<div class="row card">
				...
				<article class="offset-s2 col s8 offset-s2">
					<form action="EventoController" parent="_blank" method="POST"
						runat="server">


						<div class="input-field">
							<i class="material-icons prefix">my_location</i> <label
								for="ideve">Identificador</label> <input type="text"
								name="ideve" required>
						</div>

						<div class="input-field">
							<i class="material-icons prefix">my_location</i> <label
								for="nombre">Nombre del Evento</label> <input type="text"
								name="nombre" required>
						</div>

						<div class="input-field">
							<i class="material-icons prefix">my_location</i> <label
								for="ciudad">Ciudad</label> <input type="text" name="ciudad"
								required>
						</div>

						<div class="input-field">
							<i class="material-icons prefix">my_location</i> <label
								for="lugar">Lugar</label> <input type="text" name="lugar"
								required>
						</div>

						<div class="input-field">
							<i class="material-icons prefix">date_range</i> <label
								for="fechaini">Fecha de apertura</label> <input type="text"
								class="datepicker" name="fechaini">
						</div>
