...
<body>
	...
	<jsp:useBean id="olbDao" class="graduado.model.OfertalabDao"
	...
	<main>
		<div class="container">
			<br> <br>
			<h2 class="valign-wrapper">OFERTAS LABORALES</h2>
			<div class="divider"></div>
			<div class="section">
				<c:forEach var="o" items="${olbDao.list()}">
					<tr>
						<td>
							<h5>Oferta laboral: #${o.id}</h5>
							<p>CARGO: ${o.cargo}</p>
							<p>EMPRESA: ${o.empresa}</p>
							<p>SALARIO EN DOLARES: ${o.salario}</p>
							<p>DESCRIPCION: ${o.descripcion}</p>
							<div class="divider"></div>
						</td>
					</tr>
				</c:forEach>
