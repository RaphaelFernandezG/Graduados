...
<body>
	...
	<div class="row container">
						...
						<div class="form-container">
							...
							<div class="row">
								<div class="input-field col s12">
									...
									</select> <label>Listada de noticias</label>
								</div>
							</div>
							<div class="row">
								<div class="input-field col s12">
							...
							<div class="row">
								<div class="input-field col s12">
									<input name="descri_eveprin" type="text" class="validate"
										required> <label for="descri">Realice una descripcion del evento</label>
								</div>
							</div>
							<br>
							<center>
						...
						<div class="form-container">
							...
							<div class="row">
								<div class="input-field col s12">
									...
									</select> <label>Listado de graduados</label>
								</div>
							</div>
							<div class="row">
								<div class="input-field col s12">
									<input name="title" id="title" type="text" class="validate"
										required> <label for="title">Nivel de grado academico</label>
								</div>
							</div>
							<div class="row">
								<div class="input-field col s12">
									<input name="descr" id="descr" type="text" class="validate"
										required> <label for="descr">Realice una descripcion del graduado</label>
								</div>
							</div>
							<br>
							<center>
		...
		<!-- TABLA DE REGISTRTOS(SOLO SE MUESTRAN LOS 8 ULTIMOS -->
		<div class="card panel col s12 m12 l12">
			...
			<center>
				<a href=reportegraduados.jsp
					...
					class="material-icons right">table_chart</i>Generar Reporte General</a>
			</center>
		</div>
	</div>
