        ...
        <div class="navbar-fixed">
                <nav class="nav-extended red darken-4 ">
                  <div class="nav-wrapper red darken-2 navbar-fixed">
                    <a id="logouno" href="index." class="brand-logo flow-text truncate"><i id="marghea"
                    ...
                    <ul class="right hide-on-med-and-down">
                      ...
                      <li class="tab"><a class="dropdown-trigger waves-effect waves-black" href="" data-target="cargas">CARGAR DATOS</a></li>
                        ...
                        <ul id="cargas" class="dropdown-content red darken-2">
                                ...
                                <li><a id="lin" href="addexperiencia.">agregar experiencia</a></li>
                  ...
                  <div class="nav-content red-darken-4 hide-on-med-and-down">
                    <ul class="red-darken-4 hide-on-med-and-down">
                      <li class="tab"><a class="dropdown-trigger waves-effect waves-black" href="ofertaslabs."
                          data-target="ofertas">OFERTA
                          LABORAL</a></li>
                      <li class="tab"><a class="dropdown-trigger waves-effect waves-black" href="experiencias."
                          data-target="encuestas">EXPERIENCIAS</a></li>
                      <li class="tab"><a class="dropdown-trigger waves-effect waves-black" href="eventos.">EVENTOS</a>
                      </li>
                      <li class="tab"><a class="dropdown-trigger waves-effect waves-black" href="noticias.">NOTICIAS</a>
                      </li>
              ...
              <ul class="sidenav red darken-4" id="mobile-demo">
                <li><a id="login" class="waves-effect waves-light btn grey lighten-5" href="login."><i
                ...
                <li><a id="ext" href="ofertaslabs."><i class="material-icons">work</i>Ofertas Laborales</a></li>
                ...
                <li><a id="ext" href="experiencias."><i class="material-icons">card_membership</i>Experiencias</a></li>
              </ul>
    </header>
        ...
        <section class="container">
            <div class="row card">
                ...
                <article class="offset-s2 col s8 offset-s2">
                    <form action="GraduadoController" parent="_blank" method="POST" runat="server">
                        ...
                        <div class="input-field">
                            ...
                            <label for="fechagra">Fecha de grado</label>
                            <input type="text" class="datepicker" name="fechagra">
